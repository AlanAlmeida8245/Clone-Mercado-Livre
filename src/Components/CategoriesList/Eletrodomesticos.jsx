...
export default function Eletromesticos() {
  ...
  const getProducts = async () => {
    const response = await axios.get(
      "https://api.mercadolibre.com/sites/MLB/search?category=MLB5726"
    );
  ...
  return (
    ...
    <div>
       <h1 className="text-2xl ml-20 p-1 mt-12">Eletromestico para sua Casa<span className="ml-5 text-sm text-blue-500 font-bold">Ver Histórico</span></h1>
